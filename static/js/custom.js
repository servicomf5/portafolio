(function($) {
	...
	$(document).ready(function() {
		...
		/* ----------------------------------------------------------- */
		/*  AJAX CONTACT FORM - DESHABILITADO
		 *  Ahora usa el handler en contact.html que usa fetch en vez de jQuery
         /* ----------------------------------------------------------- */
		
		// El handler de contacto ahora está en templates/contact.html
		// usando fetch() para evitar duplicación de requests
